        ...
        <div class="card-body">
            <form action="{{ route('customer.store') }}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="no_telp" class="form-control @error('no_telp') is-invalid @enderror" name="no_telp" id="no_telp" placeholder="no_telp" autocomplete="off" value="{{ old('no_telp') }}">
                  @error('no_telp')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
